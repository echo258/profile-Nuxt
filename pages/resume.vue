<template>
  <div class="resume-container">
    ...
    <div class="resume-about-me">
      ...
      <img
        alt="image"
        src="/playground_assets/me1-200w.jpg"
        class="resume-image"
      />
    </div>
    <div class="resume-class-experience">
      ...
      <div class="resume-class-1">
        <div class="resume-cisco">
          <span class="resume-text02 sub-Heading">
            Cisco Internetworking I-IV
          </span>
      ...
      <div class="resume-class-3">
        <div class="resume-info-sys">
          <span class="resume-text13 sub-Heading">
    ...
    <div class="resume-education">
      ...
      <div class="resume-ed">
        <div class="resume-mid">
          <span class="resume-text21 sub-Heading">
      ...
      <div class="resume-ed1">
        <div class="resume-mid1">
          <span class="resume-text28 sub-Heading">
