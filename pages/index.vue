<template>
  <div class="index-container">
    ...
    <div class="index-container1">
      <img
        alt="image"
        src="/playground_assets/me-1500w.jpg"
        class="index-image"
      />
    </div>
    ...
    <div class="index-features">
      <h1 class="index-text04"><span>Highlight Skills</span></h1>
      <div class="index-container2">
        <div class="index-feature-card">
          ...
          <h2 class="index-text06">Cisco Switches / Routers</h2>
          <span class="index-text07">
            Fundamentals of computer networks and OSI model
          </span>
        </div>
        <div class="index-feature-card1">
        ...
        <div class="index-feature-card3">
          <svg viewBox="0 0 1024 1024" class="index-icon6">
            <path
          ...
          <h2 class="index-text14">NAS Server</h2>
          <span class="index-text15">Setup and maintaining of TrueNAS</span>
        </div>
      </div>
    </div>
    <div class="index-container3">
      <span class="index-text16">version 22.2.25</span>
    </div>
  </div>
</template>
...
.index-text16 {
  align-self: flex-end;
  margin-right: var(--dl-space-space-haf-unit);
